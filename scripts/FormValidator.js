export class FormValidator {
  ...
  _showError(currentInput) {
    this._errorElement = this._currentForm.querySelector(`.${currentInput.id}-error`);
  ...
  _toggleButtonState() {
    const _buttonElement = this._currentForm.querySelector(this._selectorsObject.submitButton);
